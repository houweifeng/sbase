...
#endif
#define REQUEST_MAX 81920
#define HTTP_URL_MAX 4096
#define HTTP_HOST_MAX 256
#define FILE_PATH_MAX 256
#ifndef _TYPEDEF_HTTPD
#define _TYPEDEF_HTTPD
typedef struct _HTTPD
{
	...
	int working_mode;
	int max_connections;
	int max_procthreads;/* ONLY PTHREAD MODE */
	char *logfile;
		
}HTTPD;
#endif

#ifndef TYPEDEF_HTTP_REQ
#define TYPEDEF_HTTP_REQ
...
typedef struct _HTTP_REQ{
	...
	char abspath[FILE_PATH_MAX];
	char *headers[HTTP_HEADER_NUM];
	char *server_root;
}HTTP_REQ;
#endif

#ifndef TYPEDEF_HTTP_HEADER
#define TYPEDEF_HTTP_HEADER
...
#endif
/* homepage list */
#define INDEX_HOME_NUM 4
static char *index_exts[] =
{
        "index.html",
        "index.htm",
        "home.htm",
...
static HTTP_ELEMENT http_exts[]=
{
	...
	{34, ".cpp", 4, "text/plain"},
	{35, ".log", 3, "text/plain"},
	{36, ".conf", 4, "text/plain"},
	{37, ".text", 5, "text/plain"},
	{38, ".txt", 4, "text/plain"},
	{39, ".dtd", 4, "text/xml"},
	{40, ".xml", 4, "text/xml"},
