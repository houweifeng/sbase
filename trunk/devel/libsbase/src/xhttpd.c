...
int main(int argc, char **argv)
{
    ...
    //fprintf(stdout, "sizeof(MMBLOCK):%d sizeof(CHUNK):%d sizeof(QUEUE):%d sizeof(MUTEX):%d sizeof(CONN):%d\n", sizeof(MMBLOCK), sizeof(CHUNK), sizeof(QUEUE), sizeof(MUTEX), sizeof(CONN));
